...
namespace PlayhousePlugin
{
	...
	public class Utils
	{
		...
		{
			{RoomType.HczElevatorA, new List<PosRot>{new PosRot(new Vector3(-5.9f, 2.1f, 9.6f), new Vector3(0,180,0)),
			...
			{RoomType.HczElevatorB, new List<PosRot>{new PosRot(new Vector3(3.5f, 1.6f, -0.3f), new Vector3(0,270,0))}},
			{RoomType.HczElevatorA, new List<PosRot>{new PosRot(new Vector3(3.5f, 1.6f, -0.3f), new Vector3(0,270,0))}},
